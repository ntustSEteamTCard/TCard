...
import com.TCard.demo.form.NewPostForm;
import com.TCard.demo.form.NewTopicForm;
...
public class TopicController {
	...
	public String addPost(@Valid @ModelAttribute("newPost") NewPostForm newPost, BindingResult result,
			Authentication authentication, @PathVariable int idTopic, Model model) {
	...
	public String processAndAddNewTopic(@Valid @ModelAttribute("newTopic") NewTopicForm newTopic, BindingResult result,
	...
	public String delete(@PathVariable int id, Authentication authentication, RedirectAttributes model) {
		...
		model.addFlashAttribute("message", "topic was successfully deleted");
