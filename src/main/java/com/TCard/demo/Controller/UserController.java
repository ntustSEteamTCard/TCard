...
import com.TCard.demo.form.NewUserForm;
import com.TCard.demo.form.UserEditForm;
...
public class UserController {
    ...
    public String findUserByUsernameAndViewProfilePage(@PathVariable String username,Model model) {
    ...
    public String processAndDeleteProfileAndLogout(@ModelAttribute String password,
        ...
        new SecurityContextLogoutHandler().logout(request, response, authentication);
        model.addFlashAttribute("message", "user account was deleted");
        return "redirect:/";
    }
    ...
    public String processAndSaveProfilePicture(@RequestPart MultipartFile profilePicture,
        ...
        redirectModel.addFlashAttribute("message", "user picture was successfully saved");
        return "redirect:/myprofile";
    }
